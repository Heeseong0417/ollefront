...
//import olle1 from "@/assets/videos/olle1"
const MainSlide=()=>{
    const settings = {
  ...
  responsive: [
    ...
    const ViewPage = ({key,len,title,sub,color,link, position}:any)=>{
        ...
        <source src="https://www.youtube.com/watch?v=n6iniVnyE5g" type="video/mp4" />
        ...
        <div className="sc-GKYbw mdbtn banner-pagination">
            ...
            <p className="ml-1">{len}</p>
                <div className="bg-gray-600 w-[10px] h-full mx-2"/><p className="w-full h-full">d</p>
