...
<div className="site-iu-container">
 ...
 <div className="site-iu-textbox">
  ...
  <span className="site-iu-inputtext-form">
    ...
    <input value={pageList.title} onChange={(e)=>setpageList((prev)=>{return {...prev,title:e.target.value}})} className="site-iu-inputtext" type="text" placeholder="제목" />
  </span>


  <span className="site-iu-inputtext-form">
    <p className="site-iu-inputtext-left">내용</p>
    <textarea value={pageList.description} onChange={(e)=>setpageList((prev)=>{return {...prev,description:e.target.value}})} style={{minHeight:"20rem"}} className="site-iu-inputtext" placeholder="내용" />
  </span>
